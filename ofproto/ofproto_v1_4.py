...
Extension defined by Yao Li (yaoli@email.arizona.edu) and written by Weiyang Mo (wmo@optics.arizona.edu)
"""
...
###This module is used to announce new OpenFlow message
###New OFP header is assigned
# enum ofp_type
OFPT_SETUP_CONFIG_WSS_REQUEST = 116 #/* Controller/switch message */
OFPT_SETUP_CONFIG_WSS_REPLY = 117  #/* Controller/switch message */
OFPT_TEARDOWN_CONFIG_WSS_REQUEST = 118 #/* Controller/switch message */
OFPT_TEARDOWN_CONFIG_WSS_REPLY = 119   #/* Controller/switch message */
OFPT_GET_OSNR_REQUEST = 120   #/* Controller/switch message */
OFPT_GET_OSNR_REPLY = 121   #/* Controller/switch message */

#Request message struct
#uint64_t DATAPATH_ID
#uint32_t MESSAGE_ID
#uint32_t ITU_STANDARDS
#uint32_t ELEMENT_ID
#uint32_t INPUT_INTERFACE_ID
#uint32_t OUTPUT_INTERFACE_ID
#uint32_t START_CHANNEL
#uint32_t END_CHANNEL
#uint32_t EXPERIMENT1
#uint32_t EXPERIMENT2
DATAPATH_ID_SIZE = 8
MESSAGE_ID_SIZE = 4
ITU_STANDARDS_SIZE = 4
#enum ITU_Standards
FLEXIBLE_GRID = 1<<0 # support flexible grid
ITU_C_50 = 1<<1 #support ITU Grid C-band,50 GHz
ITU_C_100 = 1<<2 #support ITU grid C_band, 100 GHz
ELEMENT_ID_SIZE = 4
INPUT_INTERFACE_ID_SIZE = 4
OUTPUT_INTERFACE_ID_SIZE = 4 
START_CHANNEL_ID_SIZE = 4 
END_CHANNEL_SIZE = 4
EXPERIMENT1_SIZE = 4
EXPERIMENT2_SIZE = 4


OFPT_SETUP_CONFIG_WSS_REQUEST_SIZE = 44
OFPT_TEARDOWN_CONFIG_WSS_REQUEST_SIZE = 44
OFPT_GET_OSNR_REQUEST_SIZE = 40



#Q -> 8 byte, H->2 byte , I->4 byte,B->1BYTE,x->padding (e.g. 2x 2byte padding)
OFPT_REQUEST_STR = '!QIIIIIIIII'
OFPT_OSNR_REQUEST_STR = '!QIIIIIIII'
assert calcsize(OFPT_REQUEST_STR) == OFPT_SETUP_CONFIG_WSS_REQUEST_SIZE
assert calcsize(OFPT_REQUEST_STR) == OFPT_TEARDOWN_CONFIG_WSS_REQUEST_SIZE
assert calcsize(OFPT_OSNR_REQUEST_STR) == OFPT_GET_OSNR_REQUEST_SIZE
...
OFPT_SETUP_CONFIG_WSS_REPLY_SIZE = 16
OFPT_TEARDOWN_CONFIG_WSS_REPLY_SIZE = 16
OFPT_GET_OSNR_REPLY_SIZE = 24

OFPT_REPLY_STR = '!QII'
OFPT_OSNR_REPLY_STR = '!QIIII'
assert calcsize(OFPT_REPLY_STR) == OFPT_SETUP_CONFIG_WSS_REPLY_SIZE
assert calcsize(OFPT_REPLY_STR) == OFPT_TEARDOWN_CONFIG_WSS_REPLY_SIZE
assert calcsize(OFPT_OSNR_REPLY_STR) == OFPT_GET_OSNR_REPLY_SIZE
#----Extension Part End------------#
